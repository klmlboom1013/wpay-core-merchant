...
import com.wpay.core.merchant.application.port.in.usecase.CellPhoneAuthVerifyUseCaseVersion;
import com.wpay.core.merchant.application.port.out.external.CellPhoneAuthVerifyExternalPort;
import com.wpay.core.merchant.application.port.out.external.CellPhoneAuthVerifyExternalVersion;
import com.wpay.core.merchant.application.port.out.persistence.CellPhoneAuthVerifyPersistencePort;
import com.wpay.core.merchant.application.port.out.persistence.CellPhoneAuthVerifyPersistenceVersion;
import com.wpay.core.merchant.domain.ActivityCellPhoneAuth;
import com.wpay.core.merchant.domain.CompleteCellPhoneAuth;
